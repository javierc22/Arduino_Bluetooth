package com.javierec.arduinobluetooth01;
...
public class DevicesBTActivity extends AppCompatActivity {

    //1)
    // Depuración de LOGCAT
    private static final String TAG = "DevicesBTActivity"; //<-<- PARTE A MODIFICAR >->->
    ...
    protected void onResume() {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this, R.layout.list_devise_bluetooth);//<-<- PARTE A MODIFICAR >->->
        // Presenta los disposisitivos vinculados en el ListView
        IdLista = findViewById(R.id.listView);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(DevicesBTActivity.this, MainActivity.class);//<-<- PARTE A MODIFICAR >->->
